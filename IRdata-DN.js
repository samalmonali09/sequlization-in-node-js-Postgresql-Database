  ...
  validator.validateXML(xmlStr, 'IR.xsd', function (err, result) {
    if (err === null) {
      ...
      var post_options = {
        ...
        // url : 'https://plt-dev.app.corpintra.net/pltshippingapimigration/submitShippingInstruction',
      ...
      console.log(post_options,'dvnsdjjsj');
...
for(var key in dict) 
{
  ...
  "country":supplierdata.country, 
       ...
       // var respdata={sqmsver_shipping_information}
        console.log(sqmsver_shipping_information);
        res.send(sqmsver_shipping_information)
      });
